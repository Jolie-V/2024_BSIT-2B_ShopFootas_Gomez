...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2024 at 09:29 PM
...
INSERT INTO `cart` (`cart_id`, `prdct_dsgn_id`, `date_added`) VALUES
(15, 32, '2024-06-02 18:20:22'),
(16, 21, '2024-06-02 18:20:24');
...
CREATE TABLE `track` (
  ...
  `order_id` int(11) NOT NULL,
  `tracking_no` varchar(55) NOT NULL,
  `shipping_status_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `product_design`
  MODIFY `prdct_dsgn_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
