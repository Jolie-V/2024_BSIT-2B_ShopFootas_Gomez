        ...
        <div class="row">
            <div class="col-md-4">
                ...
                if(isset($_GET['delete_item'])){
                    ...
                    // Step 2: Delete from the first table
                    

                    // $sql_deactivate_item = "DELETE `product_design`, `product`
                    //                         FROM `product_design`
                    //                         INNER JOIN `product`
                    //                         ON `product`.`prdct_dsgn_id` = `product_design`.`prdct_dsgn_id`
                    //                         WHERE `product_design`.`prdct_dsgn_id`='$item_id'";
            ...
            <div class="col-md-8">
                ...
                <!-- <?php
                    ...
                    while ( $row = mysqli_fetch_assoc($get_result) )
                    {?>
                    <div class="col-md-2 col-md-2 col-md-2 col-md-2">
                        <section class="cards">
                        <div class="card">
                            <img src="../user/product_pictures/<?php echo $row['item_photo'];?>" width="100px" class="img">
                            <div class="card-content">
                            <h2><?php echo $row['item_name'];?></h2>
                            <p class="<?php echo $row['item_price'];?> php"></p>
                            <button class="open-popup-btn">View Details</button>
                        </div>
                        </section>
                    </div>
                <?php }?> -->
